...
// Traue dich weiter: pro Stufe 70% Überlebenschance, Multiplikator gleicht das fair aus (1/0.7)
const CLIMB_UEBERLEBENS_CHANCE = 0.5;
const CLIMB_MULTIPLIKATOR_PRO_STUFE = 1 / CLIMB_UEBERLEBENS_CHANCE;
